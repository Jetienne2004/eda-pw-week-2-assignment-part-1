...
let mostPets;
console.log("what is the value of pets?", pets); //looking at value
console.log("what is the value of friendsPets", friendsPets);
if (pets > friendsPets) {
  mostPets = pets;
...
console.log("the most number of pets is", mostPets);
